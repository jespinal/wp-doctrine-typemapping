...
/**
 * @extends ServiceEntityRepository<WpPosts>
 *
...
class WpPostsRepository extends ServiceEntityRepository
{
    ...
    public function add(WpPosts $entity, bool $flush = false): void
    {
    ...
    public function remove(WpPosts $entity, bool $flush = false): void
    {
